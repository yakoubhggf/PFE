...
<head>
    ...
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200" />
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200" />
    <link rel="stylesheet" href="../carPage/car.css">
...
<header>
    ...
    <div class="contenu">
        ...
        <section class="admin-operation d-flex justify-content-center " >
            <div class="card "
            style="max-width: 95%;overflow-y:scroll;">
                
                <div class="card-body">
                   
                    <?php 
                    include '../../../../CRUD/car/index.php';
                   ?>
